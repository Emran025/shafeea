  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(L10nStrings.AppStrings.settingsLabel),
  ...
  Widget _buildSettingsContent(
    ...
    return CustomScrollView(
      slivers: [
        ...
        SliverToBoxAdapter(
          child: SettingsGroup(
            title: L10nStrings.AppStrings.account,
            children: [
              ModernSettingTile(
                icon: Icons.person_outline,
                iconBackgroundColor: Colors.blue,
                title: L10nStrings.AppStrings.profileTitle,
                subtitle: L10nStrings.AppStrings.accountSubtitle,
          ...
          child: SettingsGroup(
            ...
            children: [
              ModernSettingTile(
                ...
                title: L10nStrings.AppStrings.dataManagementTitle,
          ...
          child: SettingsGroup(
            ...
            children: [
              ModernSettingTile(
                ...
                subtitle: L10nStrings.AppStrings.contributeToImproveApp,
                trailing: Switch(
