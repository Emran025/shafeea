...
class PrivacyPolicyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text(AppStrings.str_student_rem_237_0139),
          ...
          if (state is SettingsLoadSuccess) {
            switch (state.policyStatus) {
              ...
              case SectionStatus.success:
                ...
                return const Center(
                  child: Text(AppStrings.str_student_rem_238_5f44),
                );
            }
          }
      ...
      slivers: [
        ...
        SliverToBoxAdapter(
          child: Padding(
            ...
            child: Text(
              AppStrings.str_student_rem_239_6aad,
      ...
      child: Padding(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                AppStrings.str_student_rem_237_0139,
