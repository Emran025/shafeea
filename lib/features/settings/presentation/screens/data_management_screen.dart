...
class DataManagementScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(L10nStrings.AppStrings.dataManagementTitle),
          centerTitle: true,
          elevation: 0,
          ...
          bottom: PreferredSize(
            ...
            child: Container(
              ...
              child: TabBar(
                ...
                tabs: [
                  Tab(text: L10nStrings.AppStrings.exportTabLabel, icon: Icon(Icons.file_download_outlined)),
                  Tab(text: L10nStrings.AppStrings.importTabLabel, icon: Icon(Icons.file_upload_outlined)),
                ],
              ),
            ),
          ),
      ...
      listener: (context, state) {
        if (state is SettingsLoadSuccess) {
          if (state.exportStatus == DataExportStatus.success) {
            _showSnackBar(context, L10nStrings.AppStrings.dataExportSuccessMessage, Colors.green);
        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              // قسم اختيار البيانات
              _SectionHeader(
                title: L10nStrings.AppStrings.dataToExportTitle,
              ...
              // قسم تنسيق الملف
              _SectionHeader(
                title: L10nStrings.AppStrings.fileFormatTitle,
                  ...
                  child: isLoading
                      ? Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 12),
                            Text(L10nStrings.AppStrings.exportingInProgressText),
                          ],
                        )
                      : Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            ...
                            SizedBox(width: 8),
                            Text(
                              L10nStrings.AppStrings.exportDataButton,
                              style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                              ),
...
class _ImportDataViewState extends State<ImportDataView> {
  String? _filePath;
  String? _fileName;
  EntityType _selectedEntityType = EntityType.followUpReport;
        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              // منطقة اختيار الملف
              _SectionHeader(
                title: L10nStrings.AppStrings.dataFileTitle,
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 12),
                      Text(
                        _fileName ?? L10nStrings.AppStrings.chooseFilePrompt,
                        style: theme.textTheme.bodyLarge?.copyWith(
                          color: _filePath != null
                              ? colorScheme.primary
                              : colorScheme.onSurface.withOpacity(0.6),
                      ...
                      if (_filePath != null)
                        Text(
                          L10nStrings.AppStrings.fileSelectedReadyForImport,
              ...
              _SectionHeader(
                title: L10nStrings.AppStrings.onConflictDuplicateDataTitle,
                  ...
                  child: isLoading
                      ? Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 12),
                            Text(L10nStrings.AppStrings.importingInProgressText),
                          ],
                        )
                      : Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            ...
                            SizedBox(width: 8),
                            Text(
                              L10nStrings.AppStrings.startImportButton,
                              style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                              ),
