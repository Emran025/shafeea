        ...
        if (state is SettingsLoadSuccess) {
          if (state.actionStatus == ActionStatus.success) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text(
                  L10nStrings.AppStrings.ticketSubmittedSuccessfully,
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text(
                  state.error?.message ?? L10nStrings.AppStrings.ticketSubmissionFailed,
                  style: Theme.of(context).textTheme.bodyMedium?.copyWith(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                Center(
                  child: Text(
                    L10nStrings.AppStrings.submitNewTicket,
                ...
                SizedBox(height: 24),
                Text(
                  L10nStrings.AppStrings.subjectLabel,
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    hintText: L10nStrings.AppStrings.enterTicketSubjectHint,
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return L10nStrings.AppStrings.pleaseEnterSubjectError;
                    }
                    return null;
                  },
                ),
                SizedBox(height: 16),
                Text(
                  L10nStrings.AppStrings.messageLabel,
                  style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                    color: Theme.of(
                      context,
                    ).colorScheme.onBackground.withOpacity(0.87),
                ...
                TextFormField(
                  ...
                  maxLines: 5,
                  decoration: InputDecoration(
                    hintText: L10nStrings.AppStrings.enterTicketDetailsHint,
                    hintStyle: Theme.of(context).textTheme.bodyMedium?.copyWith(
                      color: Theme.of(
                        context,
                      ).colorScheme.onBackground.withOpacity(0.54),
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return L10nStrings.AppStrings.pleaseEnterMessageError;
                    }
                    return null;
                  },
                ),
                    ...
                    return SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: isLoading
                            ...
                            : Text(
                                L10nStrings.AppStrings.sendButton,
