    ...
    return _dialogShell(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 16),
          Text(
            L10nStrings.AppStrings.loadingQuranData,
    ...
    return _dialogShell(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 12),
          Text(
            L10nStrings.AppStrings.failedToLoadQuranData,
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    IconButton(
                      ...
                      color: AppColors.lightCream,
                      tooltip: L10nStrings.AppStrings.resetSelection,
                    ),
                    Expanded(
                      child: Text(
                        L10nStrings.AppStrings.chooseMemorizationRange,
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontSize: 18,
                          fontWeight: FontWeight.bold,
                ...
                SizedBox(height: 4),
                Text(
                  L10nStrings.AppStrings.tapToSelectRangeInstruction,
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontSize: 12,
                  ...
                  children: [
                    Expanded(
                      child: OutlinedButton(
                        ...
                        child: Text(L10nStrings.AppStrings.cancel),
                      ),
                    ),
                    SizedBox(width: 12),
                    Expanded(
