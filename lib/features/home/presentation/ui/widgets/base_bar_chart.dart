  ...
  Widget _buildStatisticsSummary() {
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          _buildMiniStat(L10nStrings.AppStrings.averageLabel, "$avrage", ''),
          _buildMiniStat(L10nStrings.AppStrings.highestValueLabel, "${maxPoint.value}", minPoint.label),
          _buildMiniStat(L10nStrings.AppStrings.lowestValueLabel, "${minPoint.value}", maxPoint.label),
        ],
      ),
    );
  }
