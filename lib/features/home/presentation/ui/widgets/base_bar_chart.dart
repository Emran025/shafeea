  ...
  Widget _buildStatisticsSummary() {
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          _buildMiniStat(AppStrings.str_student_rem_207_da36, "$avrage", ''),
          _buildMiniStat(AppStrings.str_student_rem_208_aa63, "${maxPoint.value}", minPoint.label),
          _buildMiniStat(AppStrings.str_student_rem_209_89c0, "${minPoint.value}", maxPoint.label),
        ],
      ),
    );
  }
